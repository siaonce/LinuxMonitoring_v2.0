...
sudo goaccess -p /etc/goaccess /home/maryamgr/02/04/log*.log "$additional" --date-format=%d/%b/%Y --log-format='%h %^ %^ [%d:%t %^] \"%r\" %s %b %^ %u' --time-format=%T -o /home/maryamgr/02/06/report4.html
